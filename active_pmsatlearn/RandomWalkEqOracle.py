...
automaton_dict = {Onfsm: 'onfsm', Mdp: 'mdp', StochasticMealyMachine: 'smm', NondeterministicMooreMachine: 'nondetmm'}
...
class RandomWalkEqOracle(Oracle):
    ...
    def find_cex(self, hypothesis):
        ...
        while self.random_steps_done < self.step_limit:
            ...
            if self.automata_type in ('det', 'nondetmm'):
            ...
            elif self.automata_type == 'nondetmm' and out_sul not in out_hyp:
                if self.reset_after_cex:
                    self.random_steps_done = 0
